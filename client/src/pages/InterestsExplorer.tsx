  ...
  const mockInterests: Interest[] = [
    {
      ...
      icon: "Camera",
      details:
        "I've been practicing photography for over 8 years, focusing mainly on landscape and street photography. I enjoy capturing candid moments that tell a story about people and places. I've developed skills in composition, lighting, and post-processing with Adobe Lightroom and Photoshop.",
      relevantLinks: [
        {
        ...
        {
          title: "Photography Equipment I Use",
    ...
    },
    {
      ...
      icon: "Book",
      details:
        "I'm an avid reader with a particular interest in science fiction, speculative fiction, and philosophical literature. Some of my favorite authors include Ted Chiang, Ursula K. Le Guin, and Liu Cixin. I enjoy works that explore complex ideas about technology, consciousness, and the future of humanity.",
      relevantLinks: [
    ...
    },
    {
      ...
      icon: "Utensils",
      details:
        "I have a passion for exploring diverse cuisines from around the world. I enjoy learning about different cooking techniques, ingredients, and cultural contexts. I regularly try new recipes and have developed a small collection of specialty ingredients and cooking tools. This interest has taught me about creativity, adaptability, and attention to detail.",
    },
    {
      id: 6,
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Discover what drives and inspires me outside of my professional
              work.
            </p>
          </div>
                    ...
                    >
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-start">
                          ...
                          <div
                            className={`p-2 rounded-md ${getCategoryColor(interest.category)}`}
                          >
                      ...
                      <CardContent className="pb-2">
                        ...
                        >
                          {interest.category.charAt(0).toUpperCase() +
                            interest.category.slice(1)}
                        </Badge>
                      </CardContent>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <div
                      className={`p-3 rounded-md ${getCategoryColor(selectedInterest.category)}`}
                    >
                ...
                <CardContent className="space-y-4">
                  ...
                  {selectedInterest.relevantLinks &&
                    selectedInterest.relevantLinks.length > 0 && (
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    This interest has helped me develop creative thinking,
                    attention to detail, and a unique perspective that I bring
                    to my professional work. The skills and mindset I've gained
                    transfer directly to problem-solving and innovation.
                  </p>
                </CardContent>
              </Card>
                    ...
                    .map((interest) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div
                            className={`p-1.5 rounded-md ${getCategoryColor(interest.category)}`}
                          >
                            {getInterestIcon(interest.icon)}
                          </div>
