        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Explore my professional journey and dive into the details of my work experience.
            </p>
          </div>
              ...
              <Card>
                <CardHeader>
                  <div className="space-y-1">
                    <CardTitle className="text-2xl">{selectedExperience.role}</CardTitle>
                    <CardDescription className="text-lg">{selectedExperience.company}</CardDescription>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">50-200 employees</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Badge variant="outline" className="bg-primary/10">Project Management</Badge>
                  </div>
                </CardContent>
              </Card>
            </div>
